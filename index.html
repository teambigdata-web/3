    ...
    <span class="sr-only">Next</span>
        ...
        <div class="container-fluid">
            ...
            <section class="resume-section" id="qualifications">
                <div class="resume-section-content">
                  ...
                  <br>
                   ...
                   <br>
                    <li><strong>MBA </strong>in Finance, University of Chittagong, Chittagong 4331, Bangladesh</li>
                    </ul>
            ...
            <section class="resume-section" id="summaryofach">
                ...
                <li>26 papers are in under-review: 7 revised and resubmitted, 19 in review</li><br>
            ...
            <section class="resume-section" id="Teaching">
                <div class="resume-section-content">
                	...
                	<img align="right" src="assets/img/1.jpg" alt="1" style="width:200px;height:150px;">


                    <h2 class="mb-5">Teaching</h2> 
 
                    <h3>&nbsp &nbsp STATEMENT OF TEACHING</h3>
                    <p class="mb-0" style="position:relative; Left:35px;">My teaching philosophy focuses on teaching excellence and student accomplishment. It also
                    concentrates on conducting cutting-edge research and managing external funding.</p><br><br>
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            ...
                            <p>       
                                ...
                                <li>Akhtaruzzaman M, Moon MM, Hammami H, <strong>Abedin MZ*</strong> (2021). Deep learning-based exchange rate prediction during the COVID-19. <em>Annals of Operational Research</em> (SSCI, 2019 IF 2.583, <strong>JCR Q1</strong>). The First &ndash; round review is running [Submitted on 30th December 2020] [Manuscript # ANOR-D-20-01708] [<strong>*Corresponding author</strong>]</li><br>
...
<br><br>
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between">
						...
						<li>Fahmida Tsanim Dhonno, Dept. of FIB</li>
						<li>Mahmudul Hasan Moon, Dept. of CSE</li>
						<li>Mahbub khan Nibir, Dept. of EEE</li>
						...
						<li>ASHIKUL HOSSAIN, Dept. of CSE (BAUST)</li>
						<li>MD. ABDULLAH, Dept. of CSE (BAUST)</li>
  ...
  <footer id="footer" align="right">
    <div >
      ...
      <div class="credits">
        ...
        Designed by <a href="https://www.facebook.com/s.w.sajid">Sad Wadi Sajid</a>&nbsp<a href="mailto:wadisajid@gmail.com"><i class="fas fa-envelope"></i></a>
      </div>      
